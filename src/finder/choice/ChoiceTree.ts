...
directionalChoice
  .addNextChoice(
    new Choice('bull', 'Emelkedés', '')
      .addNextChoice(
        new Choice('bull-low-iw', 'Alacsony IV', '')
          .addNextChoice(
            new Choice(
              'call-debit-spread',
              'Call debit spread',
      ...
      .addNextChoice(
        new Choice('bull-high-iw', 'Magas IV', '')
          .addNextChoice(
            new Choice(
              'put-credit-spread',
              'Put credit spread',
          ...
          .addNextChoice(
            new Choice(
              'put-broker-butterfly',
              'Put Broken Wing Butterfly',
              'credit with no risk to the upside',
              [
                '30-60 nap',
  ...
  .addNextChoice(
    new Choice('bear', 'Esés', '')
      .addNextChoice(
        new Choice('bear-low-iv', 'Alacsony IV', '')
          .addNextChoice(
            new Choice(
              'put-debit-spread',
              'Put debit spread',
      ...
      .addNextChoice(
        new Choice('bear-high-iv', 'Magas IV', '')
          .addNextChoice(
            new Choice(
              'call-credit-spread',
              'Call credit spread',
...
neurtalChoice
  .addNextChoice(
    new Choice('neutral-low-iv', 'Alacsony IV', 'Ilyet ne csinálj inkább :(')
  )
  .addNextChoice(
    new Choice('neutral-high-iv', 'Magas IV', '')
      .addNextChoice(
        new Choice(
          'short-straddle',
          'Short straddle',
...
const mainChoices = [directionalChoice, neurtalChoice];
...
class ChoiceTree {
  ...
  private findChoice(id: string, parent: Choice): Choice | undefined {
    ...
    const choice = parent.nextChoices.reduce(
      (expectedChoice: Choice | undefined, child: Choice) => {
        if (expectedChoice) {
